...
var Posta = {
    ...
    LINK_CONFIRM_TEXT: "Tento odkaz mùže vést na stránku s nebezpeèným obsahem. Opravdu chcete pokraèovat?"
}
...
pageExtenders.add(PageExtender.create({
    ...
    analyze: function(page, context) {
        ...
        for (var i = 0; i < tableZpravyList.length; i++) {
            ...
            zprava.linkOdpovedet = $X('td//a[. = "Odpovìdìt"]', trHeader);
            zprava.linkPredat = $X('td//a[. = "Pøedat"]', trHeader);
        ...
        page.posta.zpravy.each(function(zprava) {
            ...
            if (zprava.typ == "verejna" || zprava.typ == "tajna") {
                ...
                if (data.aliance != null) {           
                    // Vytvor link
                    var linkOdpovedetVsem = Element.create("a", "Odpovìdìt všem");
